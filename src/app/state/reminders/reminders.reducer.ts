...
import { addReminder, addReminderError, addReminderSuccess, deleteReminder, deleteReminderError, deleteReminderSuccess, loadReminders, loadRemindersError, loadRemindersSuccess, updateReminder, updateReminderError, updateReminderSuccess } from "./reminders.action";
...
export const reminderReducer = createReducer(
  ...
  on(updateReminderSuccess, (state, { data }) => {
    ...
    return { ...state, reminders, selectedReminder: data, savingStatus: 'success' as const };
  }),
